...
contains
    subroutine collect_open_form(test_suite)
        ...
        test_suite = [ &
                     ...
                     , new_unittest("get_open_form_default() should return UNFORMATTED for direct/stream access", &
                                    open_form_default_returns_unformatted_for_direct_or_stream) &
                     , new_unittest("get_open_form_default() should return FORMATTED for sequential access", &
                                    open_form_default_returns_formatted_for_sequential_or_default) &
